...
version: 1.0.0
description: |
  Compile MQL5/MQ5 Expert Advisors on macOS MT5/Wine and run MetaTrader 5
  Strategy Tester backtests from CLI configs. Use when compiling .mq5 to .ex5,
  copying EAs into MQL5/Experts, creating MT5 tester .ini files, running
  "Every tick" or "Every tick based on real ticks" models, collecting reports,
  parsing Strategy Tester metrics, or comparing CONSERVATIVE/BALANCED/AGGRESSIVE
  presets on macOS.
license: MIT
